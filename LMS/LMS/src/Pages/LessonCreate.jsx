...
//     module_id: moduleId,
//     title: "",
//     content_type: "video", // or 'text', etc.
//     content: "",
//     duration: "",
//     order: "",
//     is_free: false,
...
//   //     axios.get(`http://localhost:5000/modules/module/${course_id}`)
...
//     e.preventDefault();
//     try {
//       await axios.post(`http://localhost:5000/lessons/${moduleId}`, form);
...
//             className="form-control"
//             name="content"
//             placeholder="text ... video url... quize..."
//             rows="4"
//             value={form.content}
//             onChange={handleChange}
//           ></textarea>
